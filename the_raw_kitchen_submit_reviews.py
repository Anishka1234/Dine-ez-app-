...
def submit_review():
    ...
    if review_text != '' and username:
        ...
        try:
            cursor.execute('''
                INSERT INTO the_raw_kitchen_reviews (username, user_review) VALUES (?, ?)
